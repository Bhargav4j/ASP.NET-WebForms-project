...
public class FilmService : IFilmService
{
    ...
    public async Task<Film> CreateAsync(Film film, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var result = await _repository.AddAsync(film, cancellationToken);
            _logger.LogInformation("Film created successfully with ID {FilmId}", result.Id);
    ...
    public async Task UpdateAsync(int id, Film film, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.LogInformation("Film with ID {FilmId} updated successfully", id);
        }
        catch (Exception ex)
        {
    ...
    public async Task DeleteAsync(int id, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.LogInformation("Film with ID {FilmId} deleted successfully", id);
        }
        catch (Exception ex)
        {
