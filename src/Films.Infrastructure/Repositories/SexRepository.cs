...
public class SexRepository : ISexRepository
{
    ...
    public async Task<Sex?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving sex with ID {SexId}", id);
            throw;
        }
    }
    ...
    public async Task<Sex> AddAsync(Sex sex, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error adding sex {SexName}", sex.Name);
            throw;
        }
    }
    ...
    public async Task UpdateAsync(Sex sex, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error updating sex with ID {SexId}", sex.Id);
            throw;
        }
    }
    ...
    public async Task DeleteAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error deleting sex with ID {SexId}", id);
            throw;
        }
    }
    ...
    public async Task<bool> ExistsAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error checking existence of sex with ID {SexId}", id);
            throw;
        }
    }
