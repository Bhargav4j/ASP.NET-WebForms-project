...
/// <summary>
/// EF Core repository implementation for Film entity
/// </summary>
public class FilmRepository : IFilmRepository
{
    ...
    public async Task<Film?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving film with ID {FilmId} from database", id);
            throw;
        }
    }
    ...
    public async Task UpdateAsync(Film film, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error updating film with ID {FilmId} in database", film.Id);
            throw;
        }
    }
