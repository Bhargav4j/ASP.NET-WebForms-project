...
/// <summary>
/// Repository interface for DirectedBy entity operations
/// </summary>
public interface IDirectedByRepository
{
    ...
    Task<DirectedBy> AddAsync(DirectedBy entity, CancellationToken cancellationToken = default);

    Task UpdateAsync(DirectedBy entity, CancellationToken cancellationToken = default);
