...
public interface IDirectedByRepository
{
    ...
    Task<DirectedBy> AddAsync(DirectedBy directedBy, CancellationToken cancellationToken = default);
    Task UpdateAsync(DirectedBy directedBy, CancellationToken cancellationToken = default);
